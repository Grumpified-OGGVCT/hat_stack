...
export const HAT_STACK_TOOLS: Tool[] = [
  ...
  // --- Skills taxonomy tool ---
  {
    ...
    description:
      "Recommend relevant skills from the _universal_skills/ taxonomy based on a task " +
    ...
    inputSchema: {
      ...
      properties: {
        task_description: {
          type: "string",
          description:
            "Description of the task or problem (e.g., 'building a Slack bot that posts notifications')",
        },
        max_results: {
          type: "number",
